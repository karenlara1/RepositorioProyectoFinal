...
public class ProductoSimple implements IProducto {
    ...
    public ProductoSimple(String idProducto, String nombre, String imagen, String categoria, double precio, EstadoProducto estadoProducto, LocalDateTime fechaHoraPublicacion, List<Comentario> comentarios) {
